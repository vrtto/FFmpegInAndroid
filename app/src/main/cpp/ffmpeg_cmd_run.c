...
Java_com_example_ffmpeginandroid_FfmpegNativeBridge_RunCommand(JNIEnv *env, jobject type,
...
Java_com_example_ffmpeginandroid_FfmpegNativeBridge_setDebug(JNIEnv *env, jclass type, jboolean debug) {
